OBJECTS=Manager.o main.o NeuralDetector.o neural_temp.o InputProcessor.o SamplesGenerator.o NeuralYoda.o Spokesman.o
CC=g++
...
NeuralDetector.o : NeuralDetector.cpp InputProcessor.h NeuralDetector.h CommonHeader.h
	$(CC) $(CFLAGS) -c $< $(CLIBS) -o $@
neural_temp.o : neural_temp.cpp opencv2/core/core_c.h opencv2/imgproc/imgproc_c.h opencv2/highgui/highgui_c.h
	$(CC) $(CFLAGS) -c $< $(CLIBS) -o $@
